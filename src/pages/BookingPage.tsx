...
const BookingPage: React.FC = () => {
  ...
  const movie = getMovieById(selectedScreening.movieId);
  ...
  const screeningDate = new Date(selectedScreening.datetime);
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <p className="text-gray-600 mb-2">Places disponibles: <span className="font-medium">{selectedScreening.availableSeats}</span></p>
              ...
              <div className="mb-4">
                ...
                >
                  {Array.from({ length: Math.min(10, selectedScreening.availableSeats) }, (_, i) => i + 1).map(num => (
